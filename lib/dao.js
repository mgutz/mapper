...
Dao.prototype.populate = function(clause) {
  var relation = new Relation(this);
  relation.select();
  return relation.populate.apply(relation, slice.call(arguments, 0));
};
...
Dao.prototype.all = function(cb) {
  if (arguments.length === 1)
    ...
    this.client.all.apply(this.client, Array.prototype.slice.call(arguments, 0));
}
...
Dao.prototype.one = function(cb) {
  if (arguments.length === 1)
    ...
    this.client.one.apply(this.client, Array.prototype.slice.call(arguments, 0));
}
